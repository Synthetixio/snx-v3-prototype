...
export default function Pool() {
  ...
  return (
    <Box mb="2">
      <Text mt="2" mb="6">
        By pooling liquidity for markets, you’re enabling the creation synthetic
        assets on-chain. You can earn fees and rewards, but your debt may
        increase. See <em>Hedging Your Staking Position</em> for information on
        how to protect your C-Ratio.
      </Text>
      <Box mb="6">
        ...
        <Text fontSize="sm">
          ...
          <NextLink href={"/pools/example"} passHref>
            <Link
              color="blue.400"
              ml="1"
              display="inline-block"
      ...
      <Modal size="lg" isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent bg="black" color="white">
          ...
          <ModalBody>
            <Text mb="6">
              Select a pool to participate in with this staking position:
            </Text>
            <Flex
              alignItems="center"
              mb="2.5"
